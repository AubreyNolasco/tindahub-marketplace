...
export default function ShippingFeeModal({ order, open, onClose, onSaved }) {
  ...
  return <div className="fixed inset-0 z-[90] grid place-items-center bg-scrim/60 p-4"><form onSubmit={submit} className="card w-full max-w-md p-6">
    ...
    <div className="mt-5">
      <button type="button" disabled={quoting} onClick={getQuote} className="flex w-full items-center justify-center gap-2 rounded-xl border border-teal-200 bg-teal-50 py-2.5 text-sm font-semibold text-teal-700 disabled:opacity-60">
