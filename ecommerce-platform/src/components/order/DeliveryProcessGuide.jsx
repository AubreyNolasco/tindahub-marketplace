    ...
    {open && <div className="fixed inset-0 z-[90] flex items-center justify-center bg-ink/65 p-4 backdrop-blur-sm" role="dialog" aria-modal="true" aria-label={guide.title}>
      <div className="max-h-[92vh] w-full max-w-xl overflow-y-auto rounded-3xl bg-white shadow-2xl">
        ...
        <div className="p-6 sm:p-8">
          ...
          <div className="mt-6 rounded-2xl border border-mango-300 bg-mango-100/50 p-4 text-sm leading-6 text-ink/65"><strong className="text-ink">Important:</strong> Shipping fee is paid directly to the rider or delivery provider upon arrival. It is not included in the RM HUB wallet total.</div>
