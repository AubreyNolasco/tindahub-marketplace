...
export default function RegistrationCalendar() {
  ...
  return <section id="registration-calendar" className="scroll-mt-20 border-y border-black/5 bg-surface py-14 sm:py-20">
    <div className="mx-auto max-w-7xl px-4 sm:px-6">
      ...
      <div className="mx-auto mt-8 max-w-5xl overflow-hidden rounded-3xl border border-black/[0.06] bg-surface-inset shadow-xl shadow-teal-900/[0.06] lg:grid lg:grid-cols-[1fr_0.9fr]">
