...
export default function ResellerProfitPanel({ product, quantity, sellingPrice, onSellingPriceChange, compact = false }) {
  ...
  return <section className={`rounded-2xl border p-4 ${profitable ? 'border-mango-300 bg-mango-100/50 dark:border-mango-700 dark:bg-mango-500/10' : 'border-coral-200 bg-coral-100 dark:border-coral-700 dark:bg-coral-500/10'}`}>
