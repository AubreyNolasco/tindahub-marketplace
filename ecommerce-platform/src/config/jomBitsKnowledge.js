...
const roleKnowledge = {
  reseller: [
    ...
    { id: 'storefront', keywords: ['storefront','store link','my product list','customer page','facebook','viber','whatsapp','how to buy'], title: 'Reseller customer store', route: '/reseller/products', answer: 'Open a Merchant product and select Get for My Product List. Then open My Product List to set your store name, profile and cover photos, introduction, and optional Facebook, phone, Viber, or WhatsApp channels. Only products you selected appear on your unique customer link. Customers use How to Buy and cannot access the main system navigation from that store page.' },
    ...
    { id: 'delivery', keywords: ['delivery','shipping','shipping fee','shipped','tracking','receive','decline'], title: 'Track delivery', route: '/reseller/orders', answer: 'After packaging, review the Merchant’s actual shipping fee in Orders. Accept it to allow dispatch, or decline it with a required note if you will not take the product. Confirm Delivery only after the items are actually received and checked.' },
    ...
    { id: 'report', keywords: ['report','sales report','inventory report','history','excel','duration','date range'], title: 'Reseller reports', route: '/reseller/reports/sales', answer: 'Choose a duration or custom dates, select Apply Period, review the loaded period and totals, then download Excel. The workbook contains only the applied period. Customer income is realized only after you record the customer payment as Paid.' }
  ],
  merchant: [
    ...
    { id: 'order', keywords: ['order','customer order','processing','confirm','shipping fee','packaging'], title: 'Process an order', route: '/merchant/orders', answer: 'Move an accepted order to Processing, package the exact items, and submit the actual shipping fee. Dispatch remains locked until the Reseller accepts. If declined, review the required note and submit a revised fee when appropriate.' },
    ...
    { id: 'report', keywords: ['report','sales report','inventory report','history','excel','duration','date range'], title: 'Merchant reports', route: '/merchant/reports/sales', answer: 'Choose a duration or custom dates, select Apply Period, review the loaded period and totals, then download Excel. Sales, orders, top-ups, and withdrawals use that period; Inventory is a live stock snapshot.' }
  ]
}
