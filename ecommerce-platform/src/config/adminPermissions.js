export const ADMIN_PERMISSIONS = [
  ...
  ['homepage', 'Homepage'], ['chats', 'Chat History'], ['login_history', 'Login History'],
  ['reviews', 'Reviews & Ratings'], ['campaigns', 'Campaigns'], ['registrations', 'Registration Calendar'],
...
const permissionPaths = { overview: '/admin', merchants: '/admin/merchants', categories: '/admin/categories', homepage: '/admin/homepage', chats: '/admin/chats', login_history: '/admin/login-history', reviews: '/admin/reviews', campaigns: '/admin/campaigns', registrations: '/admin/registrations', payments: '/admin/payments', topups: '/admin/topups', withdrawals: '/admin/withdrawals', wallet: '/admin/wallet', sales: '/admin/sales', subscriptions: '/admin/subscriptions', reports: '/admin/reports/sales' }
