...
const benefits = [
  ...
  { icon: Sparkles, title: 'Guided account setup', text: 'Progress checklists and recommended next actions guide each role through account, wallet, customer, product, and first-order setup.' },
  ...
  ,{ icon: Smartphone, title: 'Faster mobile workspace', text: 'Resellers and Merchants can move between Home, Products, Orders, Wallet, and Account using a phone-friendly bottom navigation.' }
]
