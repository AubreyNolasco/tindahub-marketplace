    ...
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
      ...
      <div className="space-y-4">
        {TYPES.map(({ value, label, icon: Icon, desc }) => (
          <label key={value} className={`flex cursor-pointer items-start gap-4 rounded-2xl border-2 p-5 transition ${serviceType === value ? 'border-teal-600 bg-teal-50 shadow-md dark:bg-teal-500/10' : 'border-black/[0.06] bg-surface hover:border-teal-200 hover:shadow-soft'}`}>
