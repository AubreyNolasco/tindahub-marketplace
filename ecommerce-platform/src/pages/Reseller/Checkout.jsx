  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="card border-mango-300 bg-mango-100/50 p-5"><div className="flex items-start gap-3"><span className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-white text-mango-600"><Truck size={19} /></span><div><h2 className="font-semibold text-ink">Shipping fee is paid upon delivery</h2><p className="mt-1 text-sm leading-6 text-ink/60">The reseller or final recipient will pay the actual delivery fee directly to the rider or delivery provider when the products arrive. This fee is not included in the RM HUB wallet payment.</p></div></div></div>
